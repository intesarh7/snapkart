...
/>
                        ...
                        {/* Top Rated */}
                        {p.rating >= 4 && (
                          <span className="absolute bottom-4 left-4 bg-green-500 text-white text-xs px-3 py-1 rounded-md font-medium shadow">
                            Top Rated
                          </span>
                        )}
